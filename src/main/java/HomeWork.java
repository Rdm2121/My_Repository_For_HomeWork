 ...
 */
    ...
    public static void printThreeWords() {
        System.out.println("Три моих любимых фрукта:");
    ...
    public static void printColor() {
        System.out.println("Теперь давайте узнаем какой цвет соответствует определенному числу");
    ...
    public static void compareNumbers() {
        System.out.println("Теперь сравним, что больше: a или b?");
        System.out.println("Введите два целых числа");
        Scanner in = new Scanner(System.in);
        int a = in.nextInt();
        int b = in.nextInt();
